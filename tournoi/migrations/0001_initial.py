    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tournoi.poule')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tournoi.team')),
            ],
        ),
        migrations.CreateModel(
            name='Match',
